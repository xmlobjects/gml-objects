...
@XMLElements({
        @XMLElement(name = "SimpleTriangle", namespaceURI = GMLConstants.GML_3_3_CE_NAMESPACE),
        @XMLElement(name = "SimpleTriangle", namespaceURI = GMLConstants.GML_3_2_NAMESPACE),
        @XMLElement(name = "SimpleTriangle", namespaceURI = GMLConstants.GML_3_1_NAMESPACE)
})
public class SimpleTriangleAdapter extends AbstractSimplePolygonAdapter<SimpleTriangle> {
    ...
    public void writeChildElements(SimpleTriangle object, Namespaces namespaces, XMLWriter writer) throws ObjectSerializeException, XMLWriteException {
        if (namespaces.contains(GMLConstants.GML_3_3_CE_NAMESPACE))
            ...
            SimpleTriangleConverter converter = writer.getProperties().get(GMLConstants.SIMPLE_TRIANGLE_CONVERTER, SimpleTriangleConverter.class);
            if (converter != null)
