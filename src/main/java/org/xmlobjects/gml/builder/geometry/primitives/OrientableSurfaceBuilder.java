...
@XMLElements({
        @XMLElement(name = "OrientableSurface", namespaceURI = Constants.GML_3_2_NAMESPACE_URI),
        @XMLElement(name = "OrientableSurface", namespaceURI = Constants.GML_3_1_NAMESPACE_URI)
})
