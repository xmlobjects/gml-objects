...
@XMLElements({
        @XMLElement(name = "GeometricComplex", namespaceURI = Constants.GML_3_2_NAMESPACE_URI),
        @XMLElement(name = "GeometricComplex", namespaceURI = Constants.GML_3_1_NAMESPACE_URI)
})
