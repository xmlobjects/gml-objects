...
public class CurveBuilder extends AbstractCurveBuilder<Curve> {
    ...
    public void writeChildElements(Curve object, Namespaces namespaces, XMLWriter writer) throws ObjectSerializeException, XMLWriteException {
        ...
        if (object.getSegments() != null)
            writer.writeElementUsingSerializer(Element.of(SerializerHelper.getTargetNamespace(namespaces), "segments"), object.getSegments(), CurveSegmentArrayPropertyBuilder.class, namespaces);
    }
}
