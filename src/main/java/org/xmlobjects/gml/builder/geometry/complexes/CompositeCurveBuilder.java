...
@XMLElements({
        @XMLElement(name = "CompositeCurve", namespaceURI = Constants.GML_3_2_NAMESPACE_URI),
        @XMLElement(name = "CompositeCurve", namespaceURI = Constants.GML_3_1_NAMESPACE_URI)
})
